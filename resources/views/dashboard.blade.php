<x-app-layout>
    ...
    <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <!-- مواعيد اليوم -->
        <div class="clinic-card flex items-center gap-4 p-6">
            <div class="rounded-lg bg-primary-soft p-3 text-primary">
        ...
        <!-- من في العيادة الآن -->
        <div class="clinic-card flex items-center gap-4 p-6">
            <div class="rounded-lg bg-success-soft p-3 text-success">
        ...
        <!-- إيرادات الشهر -->
        <div class="clinic-card flex items-center gap-4 p-6">
            <div class="rounded-lg bg-accent-soft p-3 text-accent">
        ...
        <!-- فواتير غير مدفوعة -->
        <div class="clinic-card flex items-center gap-4 p-6">
            <div class="rounded-lg bg-danger-soft p-3 text-danger">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-right">
                    <thead class="bg-surface-muted text-text-muted">
                        <tr>
                            <th class="px-4 py-3 text-xs font-medium uppercase">الوقت</th>
                            <th class="px-4 py-3 text-xs font-medium uppercase">المريض</th>
                            <th class="px-4 py-3 text-xs font-medium uppercase">الأخصائي</th>
                            <th class="px-4 py-3 text-xs font-medium uppercase">نوع الجلسة</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-surface-border">
                        ...
                        <tr class="transition hover:bg-surface-muted">
                            ...
                            <td class="px-4 py-3">
                                <span class="rounded-full px-2 py-1 text-xs" style="background-color: {{ $app->sessionType->color }}20; color: {{ $app->sessionType->color }}">
